...
class TrainingRound(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.round_number == 2:
            schools_lists = [[3, 2, 1, 0], [1, 2, 0, 3], [1, 0, 3, 2], [3, 0, 2, 1]]
        if player.round_number == 3:
            schools_lists = [[3, 0, 1, 2], [2, 1, 0, 3], [2, 3, 0, 1], [3, 2, 1, 0]]
        if player.round_number == 4:
            schools_lists = [[2, 0, 1, 3], [0, 3, 2, 1], [0, 3, 1, 2], [2, 3, 0, 1]]
        ...
        if player.round_number == 2:
            students_lists = [[2, 3, 0, 1], [1, 2, 3, 0], [1, 3, 0, 2], [2, 1, 3, 0]]
        if player.round_number == 3:
