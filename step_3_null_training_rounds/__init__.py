...
class TrainingRound(Page):
    ...
    def live_method(player: Player, data):
        ...
        # since prize is in dollars, we divide by 100 to get cents
    ...
    def vars_for_template(player: Player):
        print(round(C.PRIZES_VALUES[player.round_number - 1][0] / 100, 2))
        return {"first_prize": round(C.PRIZES_VALUES[player.round_number - 1][0] / 100, 2),
                "second_prize": round(C.PRIZES_VALUES[player.round_number - 1][1] / 100, 2),
                "third_prize": round(C.PRIZES_VALUES[player.round_number - 1][2] / 100, 2),
                "fourth_prize": round(C.PRIZES_VALUES[player.round_number - 1][3] / 100, 2),
